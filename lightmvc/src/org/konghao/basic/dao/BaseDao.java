...
public class BaseDao<T> implements IBaseDao<T> {
	...
	/**
	 * 根据别名设置查询参数 query.setParameter(key, val) 
	 * @param query
	 * @param alias  
	 */
		...
		if(alias!=null) {
			...
			for(String key:keys) {
				...
				if(val instanceof Collection) {
					//查询条件是列表
					query.setParameterList(key, (Collection)val);//一般用于in查询，可以是int数组，string 数组
				} else {
