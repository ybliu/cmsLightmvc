	...
	<sf:form method="post" modelAttribute="messageDto" id="addForm">
	       <div style="width:800px;margin:10px auto">
			...
			<table>
				<tr>
					<td> 标题：</td>
				    <td><sf:input path="title" size="77"/><sf:errors cssClass="errorContainer" path="title"/></td>
				 </tr>
				<tr>
					<td>内容：</td>
					<td><sf:textarea path="content" rows="25" cols="79"/></td>
				</tr>
				<tr>
					<td>留言者：</td>
					<td><sf:input path="author" size="77"/>
					</td>
				</tr>
				<tr>
					<td></td>
					<td><input type="button" id="addBtn"value="提交" /></td>
				</tr>
			</table>
			</div>
	</sf:form>
